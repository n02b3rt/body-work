...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('administrator', 'edytor', 'klient');
  CREATE TYPE "public"."enum_media_convert_format" AS ENUM('optimized', 'webp', 'avif', 'jpeg', 'png', 'webm', 'mp4', 'original');
  CREATE TYPE "public"."enum_media_kind" AS ENUM('image', 'video', 'document', 'other');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_post_translations_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_subscribers_status" AS ENUM('pending', 'confirmed', 'unsubscribed');
  CREATE TYPE "public"."enum_subscribers_locale" AS ENUM('pl', 'en');
  CREATE TYPE "public"."enum_components_category" AS ENUM('section', 'header', 'card', 'cta', 'other');
  ...
  CREATE TABLE "users" (
  	...
  	"first_name" varchar,
  	"last_name" varchar,
  	"role" "enum_users_role" DEFAULT 'klient' NOT NULL,
  ...
  CREATE TABLE "media" (
  	...
  	"description" varchar,
  	"slug" varchar,
  	"convert_format" "enum_media_convert_format" DEFAULT 'optimized',
  	"max_dimension" varchar DEFAULT '1920',
  	"image_quality" varchar DEFAULT 'balanced',
  ...
  CREATE TABLE "post_translations" (
  	...
  	"status" "enum_post_translations_status" DEFAULT 'draft' NOT NULL,
  	"title" varchar NOT NULL,
  	"excerpt" varchar,
  	"content" jsonb,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "subscribers" (
  	...
  	"locale" "enum_subscribers_locale" DEFAULT 'pl' NOT NULL,
  ...
  CREATE TABLE "components" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"category" "enum_components_category" DEFAULT 'section',
  	"builder" jsonb,
  	"slug" varchar NOT NULL,
  	"preview_id" integer,
  	"description" varchar,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'BodyWork Centrum' NOT NULL,
  	"tagline" varchar,
  	"logo_id" integer,
  	"favicon_id" integer,
  	"email" varchar,
  ...
  CREATE TABLE "theme_colors" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"brand_primary" varchar DEFAULT '#0f766e',
  	"brand_primary_hover" varchar DEFAULT '#115e59',
  	"brand_secondary" varchar DEFAULT '#1e293b',
  	"brand_secondary_hover" varchar DEFAULT '#0f172a',
  	"brand_accent" varchar DEFAULT '#f59e0b',
  	"text_heading" varchar DEFAULT '#0f172a',
  	"text_body" varchar DEFAULT '#334155',
  	"text_muted" varchar DEFAULT '#64748b',
  	"text_inverted" varchar DEFAULT '#ffffff',
  	"text_link" varchar DEFAULT '#0f766e',
  	"text_link_hover" varchar DEFAULT '#115e59',
  	"surface_page" varchar DEFAULT '#ffffff',
  	"surface_surface" varchar DEFAULT '#f8fafc',
  	"surface_surface_alt" varchar DEFAULT '#f1f5f9',
  	"surface_border" varchar DEFAULT '#e2e8f0',
  	"surface_overlay" varchar DEFAULT '#0f172a',
  	"state_success" varchar DEFAULT '#16a34a',
  	"state_warning" varchar DEFAULT '#d97706',
  	"state_error" varchar DEFAULT '#dc2626',
  	"state_info" varchar DEFAULT '#0284c7',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "post_translations" ADD CONSTRAINT "post_translations_post_id_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "components" ADD CONSTRAINT "components_preview_id_media_id_fk" FOREIGN KEY ("preview_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_post_translations_fk" FOREIGN KEY ("post_translations_id") REFERENCES "public"."post_translations"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_site_components_fk" FOREIGN KEY ("components_id") REFERENCES "public"."components"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "media_slug_idx" ON "media" USING btree ("slug");
  ...
  CREATE UNIQUE INDEX "post_translations_post_idx" ON "post_translations" USING btree ("post_id");
  CREATE INDEX "post_translations_updated_at_idx" ON "post_translations" USING btree ("updated_at");
  CREATE INDEX "post_translations_created_at_idx" ON "post_translations" USING btree ("created_at");
  ...
  CREATE INDEX "components_category_idx" ON "components" USING btree ("category");
  CREATE UNIQUE INDEX "components_slug_idx" ON "components" USING btree ("slug");
  CREATE INDEX "components_preview_idx" ON "components" USING btree ("preview_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_post_translations_id_idx" ON "payload_locked_documents_rels" USING btree ("post_translations_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "post_translations" CASCADE;
  ...
  DROP TABLE "theme_colors" CASCADE;
  DROP TYPE "public"."enum_users_role";
  DROP TYPE "public"."enum_media_convert_format";
  DROP TYPE "public"."enum_media_kind";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_version_status";
  DROP TYPE "public"."enum_posts_status";
  DROP TYPE "public"."enum__posts_v_version_status";
  DROP TYPE "public"."enum_post_translations_status";
  DROP TYPE "public"."enum_subscribers_status";
  DROP TYPE "public"."enum_subscribers_locale";
  DROP TYPE "public"."enum_components_category";`)
}
