...
/* The reference draws its own icons rather than using a font; these are its exact paths,
 * with the hard-coded rgb(0,60,94) swapped for `currentColor` so they follow the text. */
